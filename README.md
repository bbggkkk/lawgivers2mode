...
- 좌측 패널 옆 주황색 `CHEAT` 탭으로 인물·정당·국가·행동력을 즉시 제어
...
싱글플레이 저장 게임을 불러온 뒤 좌측 패널 옆의 주황색 `CHEAT` 탭을 누르면 메뉴가 열립니다. 게임의 TextMeshPro 한글 폰트와 회색 반투명 패널 스타일을 그대로 재사용하며, MelonLoader의 프레임 콜백에는 의존하지 않습니다.
